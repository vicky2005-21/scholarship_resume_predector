...
def extract_info(text):
    ...
    return name, email, phone, jee_score, scholarship_amount
...
def upload():
    ...
    if file and allowed_file(file.filename):
        ...
        if filename.endswith('.pdf'):
            ...
            return redirect(request.url)              
        name, email, phone, jee_score, scholarship_amount = extract_info(text)
        return render_template('uploaded.html', filename=filename, name=name, email=email, phone=phone, jee_score=jee_score, scholarship_amount=scholarship_amount)
    else:
        return redirect(request.url)
